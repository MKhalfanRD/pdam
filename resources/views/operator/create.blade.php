                ...
                <div class="bg-white p-6 rounded-lg shadow-lg w-full">
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama" id="nama"
                            class="block w-full rounded-md bg-gray-200 text-gray-900 px-3.5 py-2 mt-2 border-0" value="{{old('nama')}}">
                        @error('nama')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name="email" id="email"
                            class="block w-full rounded-md bg-gray-200 text-gray-900 px-3.5 py-2 mt-2 border-0" value="{{old('email')}}">
                        @error('email')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="text" name="alamat" id="alamat"
                            class="block w-full rounded-md bg-gray-200 text-gray-900 px-3.5 py-2 mt-2 border-0" value="{{(old('alamat'))}}">
                        @error('alamat')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="number" name="telp" id="telp"
                            class="block w-full rounded-md bg-gray-200 text-gray-900 px-3.5 py-2 mt-2 border-0" placeholder="0813xxx" value="{{old('telp')}}">
                        @error('telp')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
