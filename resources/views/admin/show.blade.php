        ...
        <div class="container mx-auto bg-white p-6 rounded-lg shadow-lg w-fit">
            ...
            @if ($pembayaran)
                ...
                <div class="text-center">
                    <p class="text-gray-600 italic">Warga ini belum melakukan pembayaran.</p>
                    <a href="{{ route('admin.index') }}">
                        <button type="button"
                            class="bg-blue-500 px-5 py-2.5 text-white rounded-md hover:bg-blue-600 focus:outline-none mt-4">Kembali</button>
                    </a>
                </div>
            @endif
        </div>
